using Books.Foundation.SitecoreExtensions.Services;
using Sitecore;
using Sitecore.Data;
...
namespace Books.Foundation.SitecoreExtensions.Extensions
{
    public static class ItemExtensions
    {
        ...
        public static string ImageUrl(this MediaItem mediaItem, int width, int height)
        {
            ...
            MediaUrlOptions options = new MediaUrlOptions { Height = height, Width = width };
        ...
        public static double? GetDouble(this Item item, ID fieldId)
        {
            ...
            if (double.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out double num) || double.TryParse(value, NumberStyles.Any, CultureInfo.GetCultureInfo("en-US"), out num) || double.TryParse(value, NumberStyles.Any, CultureInfo.CurrentCulture, out num))
            {
                return num;
            }
            return null;
